...
mvn -f ../../../../pom.xml exec:java -Dexec.args="--db-port $new_port --db-host $new_host" -Dexec.mainClass=ar.edu.unrc.exa.dc.dose2016.riocuartobandasderock.main.Bootstrap > log_app_out.txt 2> log_app_err.txt &
echo $! > .saved_pid
