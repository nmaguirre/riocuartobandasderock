Feature: The application responds appropriately to all events that correspond to the various forms of adding new bands to the system. 
    ...
    Scenario: Add a band with no name and the band's database empty
        Given that the bands' database is empty
        When I add a band with no name and genre "Rock"
        Then the bands' database should have 0 entries
    
    Scenario: Add a band with no name and the band's database have some entries
        Given that the bands' database have 5 entries
        When I add a band with no name and genre "Rock"
        Then the bands' database should have 5 entries
    
    Scenario: Add a band with no name, no genre and the band's database empty
        Given that the bands' database is empty
        When I add a band with no name and no genre
        Then the bands' database should have 0 entries
    
    Scenario: Add a band with no name, no genre and the band's database have some entries
        Given that the bands' database have 5 entries
        When I add a band with no name and no genre
        Then the bands' database should have 5 entries
    
    Scenario: Add a band with no genre and the band's database empty
        Given that the bands' database is empty
        When I add a band with name "ACDC" and no genre
        Then the bands' database should have 0 entries
    
    Scenario: Add a band with no genre and the band's database have some entries
        Given that the bands' database have 5 entries
        When I add a band with name "ACDC" and no genre
        Then the bands' database should have 5 entries
